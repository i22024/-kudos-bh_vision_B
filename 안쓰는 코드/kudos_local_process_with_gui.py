...
#def listen_from_op3(data):
#    print("\n\n")
#    print(data.data)

#def run_read_op3_msg(Is_local_q, priROS):
#    #rospy.init_node('soccer_simu_sensor_processor2', anonymous = True)
#    print("hello?")
#    rospy.Subscriber("op3_local_mode_msg", rosBool, listen_from_op3)
#    print("deldlel")
#    rospy.spin()
